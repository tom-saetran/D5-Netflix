                ...
                <div className="col-md-2">
                    <div className="d-flex justify-space-between">
                        <a rel="noreferrer" target="_blank" href="https://facebook.com/netflix">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-facebook text-secondary" viewBox="0 0 16 16">
                        ...
                        <a rel="noreferrer" target="_blank" href="https://www.instagram.com/netflix/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-instagram text-secondary" viewBox="0 0 16 16">
                        ...
                        <a rel="noreferrer" target="_blank" href="https://twitter.com/netflix">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-twitter text-secondary" viewBox="0 0 16 16">
                        ...
                        <a rel="noreferrer" target="_blank" href="https://www.youtube.com/channel/UCWOA1ZGywLbqmigxE4Qlvuw">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-youtube text-secondary" viewBox="0 0 16 16">
